                ...
                <div class="col-12   mt-4">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="text-center">Distribute Meeting To Other Agents</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('updateMeetingAgent',$agentID->id) }}" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                            ...
                            <div class="card-footer">
                                <a href="{{ route('viewAgentMeeting') }}" class="btn btn-primary">Back</a>
